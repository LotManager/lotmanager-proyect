...
export default function AgregarEmpleadoModal({ isOpen, onClose, onSave }: Props) {
    ...
    // 2. Estado del formulario (SIN TELÉFONO)
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Al guardar, enviamos los datos. 
        // NOTA: Si tu tipo 'Empleado' obliga a tener teléfono, le pasamos un string vacío o guion.
        onSave({
            ...formData,
            telefono: '', // Lo enviamos vacío para cumplir con el tipo de datos
        });
        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-2xl w-full max-w-md p-6 border border-gray-200 max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {/* EMAIL (Ahora ocupa todo el ancho) */}
                    <div>
                    ...
                    {/* ROL Y ESTADO (Selects en grilla de 2 columnas) */}
